    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-primary px-4 px-lg-5 py-3 py-lg-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav mx-auto py-0">
                ...
                <a href="gallery.php" class="nav-item nav-link <?php if($page=="gal") echo 'active'?>">Gallery</a>
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="scheduleDropdown">
                        ...
                        <a class="dropdown-item" href="https://yp.ieeebangalore.org/conecct-yp-meet-2023/" target="_blank">YP Meet</a>
                    </div>
                </li>
                <li class="nav-item dropdown">
